...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-what-ml-is.html", "a2-how-a-model-learns.html",
           "a3-the-data-is-the-model.html", "a4-reading-the-report-card.html",
           "a5-prediction-is-not-proof.html", "a6-ml-responsibly.html"]
        : ["b1-setup-and-first-dataset.html", "b2-train-test-split.html", "b3-first-model-end-to-end.html",
           "b4-over-and-underfitting.html", "b5-bias-variance-regularization.html", "b6-cross-validation-and-tuning.html",
           "b7-classification-metrics.html", "b8-regression-metrics.html",
           "b9-pipelines-and-features.html", "b10-capstone-compare-models.html"];
